<template>
  <q-page
    ...
    padding
  >
    <stopwatch-preparing-cast v-if="state.name === 'preparing'" />
    <stopwatch-running-cast
      v-else
      :state="state"
    />
  </q-page>
...
const state = computed<StopwatchState>(() => {
  return castStore.gameState as StopwatchState;
});
</script>
